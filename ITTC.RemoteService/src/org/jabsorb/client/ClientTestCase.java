...
public class ClientTestCase extends ServerTestBase
{
	...
	{
		super.setUp(); // Makes sure jabsorb server tests are running at this
						// URL
	 ...
	 */
	void setupServerTestEnvironment(String url) throws HttpException,
			IOException
	{
	...
	public void testBadClient()
	{
		Client badClient = new Client(
				registry.createSession("http://non-existing-server:99"));
		try
		{
	...
	public void testHTTPSession()
	{
		Client client = new Client(
				newHTTPSession("http://localhost:8084/webapps/jsonrpc/"));
		ITest test = (ITest) client.openProxy(null, ITest.class);
		System.out.println(test.addInt(3, 4));
	}
	...
	{
		ClientTestCase case1 = new ClientTestCase();
		// case1.testProxyConfiguration();
	}
