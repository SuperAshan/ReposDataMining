...
public class Timeline extends Weibo{
	...
	public StatusWapper getUserTimelineByUid(String uid, int count,int page, int trim_user) throws WeiboException {
		return Status.constructWapperStatus(client.get(WeiboConfig
	...
	public StatusWapper getUserTimelineByName(String screen_name,   int count, int page, int trim_user) throws WeiboException {
		return Status.constructWapperStatus(client.get(WeiboConfig
				.getValue("baseURL") + "statuses/user_timeline.json",new PostParameter[]{
	...
	public StatusWapper getUserTimelineByUid(String uid, Paging page,
			Integer base_app, Integer feature, int count, int trim_user) throws WeiboException {
		return Status.constructWapperStatus(client.get(
	...
	public StatusWapper getUserTimelineByName(String screen_name, Paging page,Integer base_app, Integer feature, int count, int trim_user) throws WeiboException {
		return Status.constructWapperStatus(client.get(
						WeiboConfig.getValue("baseURL")	+ "statuses/user_timeline.json",
						new PostParameter[] {
								new PostParameter("screen_name", screen_name),
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getUserTimelineIdsByUid(String uid, int count, int page) throws WeiboException{
	...
	public JSONObject getUserTimelineIdsByName(String screen_name, int count, int page) throws WeiboException{
		return client.get(WeiboConfig.getValue("baseURL")+"statuses/user_timeline/ids.json",new PostParameter[]{
			new PostParameter("screen_name", screen_name),new PostParameter("count", count),
			new PostParameter("page", page),
		}).asJSONObject();
	}
	/**
	...
	public StatusWapper getRepostTimeline(String id, int count, int page) throws WeiboException {
		return Status.constructWapperStatus(client.get(
				...
				new PostParameter[] { new PostParameter("id", id),new PostParameter("count", count),
					new PostParameter("page", page), }));
	}
	 ...
	 * @since JDK 1.5
	 */
	public StatusWapper getRepostTimeline(String id, int count ,Paging page)
			throws WeiboException {
		return Status.constructWapperStatus(client.get(
				WeiboConfig.getValue("baseURL")
						+ "statuses/repost_timeline.json",
	 ...
	 * @since JDK 1.5
	 */
	public JSONObject getRepostTimelineIds(String id, int count) throws WeiboException {
		return client.get(
				WeiboConfig.getValue("baseURL") + "statuses/repost_timeline/ids.json",
				new PostParameter[] { new PostParameter("id", id),new PostParameter("count", count) }).asJSONObject();
	}
	/**
	 * 获取当前用户最新转发的微博列表
	 * 
