...
public class Test implements Serializable, ITest
{
	...
	public List echoList(ArrayList l)
	{
		return l;
	}
	...
	// Callback tests
	/*
	 * public void setCallback(JSONRPCBridge bridge, boolean flag) { if (flag) {
	 * bridge.registerCallback(cb, HttpServletRequest.class); } else {
...
//				AccessibleObject m, Object arguments[]) throws Exception
//		{
...
//				AccessibleObject m, Object result) throws Exception
//		{
//		}
//	};
