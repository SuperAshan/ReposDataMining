package PositionProcess.FastForceDirected;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import Tool.ConvertClass;
import Data.IPositionComputeable;
import Data.IPositionProcess;

 
 
public class FastForceDirected extends IPositionProcess
{
	public void script(int[] adjacency, int nodeNum) throws IOException {
...
//	}
	...
	{
		int[] adjacency=ConvertClass.RelationToAdjancy(this.relationMatrix);
...
//		this.script(adjacency,nodenumber);
		...
		{
			System.out.format("(%f,%f)", this.Nodes.get(i).getPositionX(), this.Nodes.get(i).getPositionY());
			i++;
			if(i%10==0)
				System.out.print("\n");
		}
